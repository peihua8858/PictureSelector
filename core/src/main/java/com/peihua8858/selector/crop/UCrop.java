...
import com.peihua8858.selector.BuildConfig;
...
public class UCrop {
    ...
    public Intent getIntent(@NonNull Context context) {
        ...
        if (dataSource != null && dataSource.size() > 1) {
            mCropIntent.setAction(PhotoCropVisualMedia.ACTION_MULTIPLE_CROP_IMAGES);
        } else {
            mCropIntent.setAction(PhotoCropVisualMedia.ACTION_CROP_IMAGES);
        }
...
//        public static final String EXTRA_UCROP_LOGO_COLOR = EXTRA_PREFIX + ".UcropLogoColor";
        ...
        /**
         * Set one of {@link Context#getExternalFilesDirs(String)} The path that will be used to save
         ...
         */
        public T setAllowedGestures(@GestureTypes int tabScale,
