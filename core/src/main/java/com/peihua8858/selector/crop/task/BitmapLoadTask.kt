package com.peihua8858.selector.crop.task
...
import com.peihua8858.selector.crop.OkHttpClientStore
import com.peihua8858.selector.crop.callback.BitmapLoadCallback
import com.peihua8858.selector.crop.model.ExifInfo
import com.peihua8858.selector.crop.util.BitmapLoadUtils
import com.peihua8858.selector.utils.adjustBitmapOrientation
import com.peihua8858.tools.coroutine.ModernAsyncTask
...
) : ModernAsyncTask<Void, Void, BitmapLoadTask.BitmapWorkerResult>() {
