...
import com.peihua8858.selector.utils.Utils;
...
public class Category {
    ...
    public static Category fromCursor(@NonNull Cursor cursor) {
        long bucketId = CursorExtKt.getLong(cursor, MediaStore.MediaColumns.BUCKET_ID);
        String id = CursorExtKt.getString(cursor, MediaStore.MediaColumns._ID);
        String mMimeType = CursorExtKt.getString(cursor, MediaStore.MediaColumns.MIME_TYPE);
        String realPath = CursorExtKt.getString(cursor, MediaStore.MediaColumns.DATA);
        String displayName = CursorExtKt.getString(cursor, MediaStore.MediaColumns.BUCKET_DISPLAY_NAME);
        ...
        Category category = new Category(bucketId, id, displayName,
                coverUri,
                CursorExtKt.getInt(cursor, ItemsProvider.COLUMN_COUNT),
                true);
