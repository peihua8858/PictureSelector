...
import com.peihua8858.selector.crop.decoration.GridSpacingItemDecoration
import com.peihua8858.selector.crop.model.AspectRatio
import com.peihua8858.selector.crop.model.CustomIntentKey
...
import com.peihua8858.tools.utils.isAtLeastM
...
//        mToolbarCropDrawable = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_WIDGET_CROP_DRAWABLE, R.drawable.ucrop_ic_done);
    ...
    private fun setGalleryAdapter() {
        ...
        val galleryBarBackground = intent.getIntExtra(
            ...
            com.peihua8858.selector.R.drawable.picker_crop_gallery_bg
        )
        ...
        galleryAdapter!!.setOnItemClickListener OnItemClickListener@{ position, view ->
            ...
            if (filterSet.contains(mimeType)) {
                Toast.makeText(
                    applicationContext,
                    getString(com.peihua8858.selector.R.string.picker_crop_not_crop), Toast.LENGTH_SHORT
                ).show()
                return@OnItemClickListener
            }
    ...
    private fun setupViews(intent: Intent) {
        ...
        mToolbarTitle =
            if (mToolbarTitle != null) mToolbarTitle
            else resources.getString(com.peihua8858.selector.R.string.picker_crop_label_edit_photo)
        setupAppBar()
    }
    ...
    private fun setupAppBar() {
        ...
        mToolbarCropDrawable = ta.getResourceId( /* index */0,  /* defValue */com.peihua8858.selector.R.drawable.picker_crop_ic_done)
