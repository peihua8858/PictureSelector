...
import com.peihua8858.selector.android.databinding.PickerCropActivityPhotoboxBinding
import com.peihua8858.selector.android.databinding.PickerCropControlsBinding
import com.peihua8858.selector.crop.callback.BitmapCropCallback
import com.peihua8858.selector.crop.drawable.SelectedStateListDrawable
import com.peihua8858.selector.crop.model.AspectRatio
import com.peihua8858.selector.crop.util.FileUtils
import com.peihua8858.selector.crop.widget.AspectRatioTextView
import com.peihua8858.selector.crop.widget.CropImageView
import com.peihua8858.selector.crop.widget.GestureCropImageView
import com.peihua8858.selector.crop.widget.HorizontalProgressWheelView
import com.peihua8858.selector.crop.widget.OverlayView
import com.peihua8858.selector.crop.widget.TransformImageView
import com.peihua8858.selector.crop.widget.UCropView
...
class UCropActivity : AppCompatActivity() {
            ...
            try {
                ...
                Log.i(
                    ...
                    String.format(
                        "%s - %s",
                        e.message,
                        getString(com.peihua8858.selector.R.string.picker_crop_mutate_exception_hint)
                    )
                )
            }
    ...
    private fun setImageData(intent: Intent) {
        ...
        if (inputUri != null && outputUri != null) {
            ...
            setResultError(NullPointerException(getString(com.peihua8858.selector.R.string.picker_crop_error_input_data_is_absent)))
            finish()
        }
    }
    ...
    private fun processOptions(intent: Intent) {
        ...
        mOverlayView.setCropFrameStrokeWidth(
            intent.getIntExtra(
                ...
                resources.getDimensionPixelSize(com.peihua8858.selector.R.dimen.picker_default_crop_frame_stoke_width)
            )
        )
        ...
        mOverlayView.setCropGridStrokeWidth(
            intent.getIntExtra(
                ...
                resources.getDimensionPixelSize(com.peihua8858.selector.R.dimen.picker_default_crop_grid_stoke_width)
            )
        )
    ...
    private fun setupViews(intent: Intent) {
        ...
        mToolbarTitle =
            if (mToolbarTitle.isNonEmpty()) mToolbarTitle else resources.getString(com.peihua8858.selector.R.string.picker_crop_label_edit_photo)
        mShowBottomControls =
    ...
    private fun setupAppBar() {
        ...
        mToolbarCropDrawable =
            ta.getResourceId( /* index */0,  /* defValue */com.peihua8858.selector.R.drawable.picker_crop_ic_done)
...
//        val actionBar = supportActionBar
    ...
    private fun setupAspectRatioWidget(intent: Intent) {
        ...
        if (aspectRatioList.isEmpty()) {
            ...
            aspectRatioList.add(
                AspectRatio(
                    getString(com.peihua8858.selector.R.string.picker_crop_label_original).uppercase(Locale.getDefault()),
