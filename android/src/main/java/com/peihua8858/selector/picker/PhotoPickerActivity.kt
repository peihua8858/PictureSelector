...
import com.peihua8858.selector.android.databinding.PickerActivityPhotoPickerBinding
import com.peihua8858.selector.picker.fragment.TabContainerFragment
import com.peihua8858.selector.utils.LayoutModeUtils
import com.peihua8858.selector.utils.LayoutModeUtils.MODE_PHOTOS_TAB
...
//        enableEdgeToEdge()
    ...
    private fun setRoundedCornersForBottomSheet() {
        val cornerRadius = resources.getDimensionPixelSize(com.peihua8858.selector.R.dimen.picker_top_corner_radius).toFloat()
    ...
    private fun updateToolbar(mode: LayoutModeUtils.Mode) {
        ...
        if (shouldShowTabLayout) {
            icon = getDrawableCompat(com.peihua8858.selector.R.drawable.picker_ic_close)
        } else {
            icon = getDrawableCompat(com.peihua8858.selector.R.drawable.picker_ic_arrow_back)
