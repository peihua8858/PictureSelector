...
import com.peihua8858.selector.android.databinding.PickerFragmentPreviewBinding
...
class PreviewFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            view.accessibilityPaneTitle = getString(com.peihua8858.selector.R.string.picker_preview)
        }
    ...
    companion object {
        ...
        private fun updateSelectButtonText(
            ...
            selectButton.setText(if (isSelected) com.peihua8858.selector.R.string.picker_deselect
            else com.peihua8858.selector.R.string.picker_select)
        }
        ...
        private fun updateSelectedCheckButtonStateAndText(
            ...
            selectedCheckButton.setText(if (isSelected) com.peihua8858.selector.R.string.picker_selected
            else com.peihua8858.selector.R.string.picker_deselected)
        ...
        private fun generateAddButtonString(context: Context, size: Int): String {
            ...
            val template = context.getString(com.peihua8858.selector.R.string.picker_add_button_multi_select)
