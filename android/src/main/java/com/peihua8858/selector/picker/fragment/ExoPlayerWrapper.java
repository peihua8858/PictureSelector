...
class ExoPlayerWrapper {
    ...
    private void updateMuteButtonContentDescription(ImageButton muteButton, boolean isVolumeMuted) {
        muteButton.setContentDescription(
                mContext.getString(
                        isVolumeMuted ? com.peihua8858.selector.R.string.picker_unmute_video
                                : com.peihua8858.selector.R.string.picker_mute_video));
    }

    private void updateMuteButtonIcon(ImageButton muteButton, boolean isVolumeMuted) {
        muteButton.setImageResource(
                isVolumeMuted ? com.peihua8858.selector.R.drawable.picker_ic_volume_off
                        : com.peihua8858.selector.R.drawable.picker_ic_volume_up);
    }
